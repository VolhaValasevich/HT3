...
public class GitHubAutomationTest
{
	...
	public void oneCanStarAndUnstarRepository()
	{
		...
		Assert.assertTrue(steps.starCurrentRepository(), "[Failed to star a repository!]");
		Assert.assertTrue(steps.unstarCurrentRepository(), "[Failed to unstar a repository!]");
	}
